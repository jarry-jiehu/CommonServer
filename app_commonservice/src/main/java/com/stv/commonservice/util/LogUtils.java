...
public final class LogUtils {
    /************************ Module name *************************/
    public static final String MODULE_DOMAIN = "GetDomain";
    public static final String MODULE_APPUPDATE = "AppUpdater";
    public static final String MODULE_ATTEST = "GetAttest";
    public static final String MODULE_ACTIVATION = "Activation";
    public static final String MODULE_REMOTERUPDATE = "RemoterUpdate";
    public static final String MODULE_REMOTE_CONTROL = "RemoteControl";
    public static final String MODULE_SMART_HOME = "SmartHome";
    public static String sTag = "CommonService";
    // default module
    ...
    public void log2File(String log) {
        synchronized (sLogLock) {
            ...
            String file = DateUtils.formatDate(System.currentTimeMillis(), "yyyyMMdd");
